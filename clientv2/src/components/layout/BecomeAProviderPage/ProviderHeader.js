            ...
            <div className="relative z-2 w-full max-w-screen-xl mx-auto px-6 lg:px-8">
                <div className="m-0 max-w-none text-center overflow-hidden">
                    ...
                    <h2 className="py-0 px-[10px] max-w-none text-white font-medium mx-auto mt-0 mb-[20px] text-center text-lg leading-5 tracking-wider">
                        Whether you own a hotel, shop or cafe, you can monetise on any unsed space
                    </h2>

                    <a className="mx-0 my-[18px] min-w-[160px] h-[48px] leading-[48px] text-lg text-center font-medium bg-gray-200 text-gray-700 shadow-md rounded-md inline-block px-6 border-none transition duration-200 ease-in-out hover:bg-gray-300 hover:text-gray-600"
                        href="/login/provider">
                        Get started today
                    </a>
                </div>
