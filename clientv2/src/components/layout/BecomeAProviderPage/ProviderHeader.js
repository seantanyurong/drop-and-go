const ProviderHeader = () => {
    return (
        <div className="block py-[50px] relative border-b-1 border-solid border-border-main bg-gradient-to-b from-primary-100 to-primary-200">
            ...
            {/* Provider Header's Background Image  */}
            <div className="absolute top-0 left-0 w-full h-full opacity-10">
                <div className="text-base leading-5 tracking-tighter">
                    <img
                        className="absolute top-0 left-0 w-full h-full bg-ccesf8 opacity-100 object-cover z-0"
                        src="https://res.cloudinary.com/dpiued5io/image/upload/v1679986076/01Grocery5-jumbo_w74alz.jpg"
                    />
                </div>
            </div>
            ...
            <div className="relative z-2 w-full max-w-screen-xl mx-auto px-6 lg:px-8">
                <div className="m-0 max-w-none text-center overflow-hidden">
                    ...
                    {/* Body Text */}
                    <h2
                        className="py-0 px-[10px] max-w-none text-white font-medium mx-auto mt-0 mb-[20px] text-center text-lg leading-5">
