...
const ViewBusinessHours = () => {
    ...
    // navigate to specific business hour to edit
    const navigate = useNavigate();
    function handleClick(id) {
        navigate(`/provider/edit-business-hours/${id}`);
    }

    // navigate to page to add business hours
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            // get all business hours created by user
                    ...
                    <div className="flex-col sm:flex-row flex items-center justify-between relative">
                        ...
                        <nav className="flex grow mt-4 sm:mt-0">
                            <ul className="flex grow justify-end flex-wrap items-center">
                                ...
                                <li
                                    onClick={() => navigate(`/provider/view-locations`)}
                            ...
                            <div className="m-2 border-[1px] border-border-main p-4 rounded-md mb-4 shadow-md hover:bg-box-hover">
                                <div className="flex items-center mb-1 justify-between">
                                    ...
                                    <div
                                        ...
                                        onClick={() => handleClick(businessHourSetting._id)}
                                    >
                                        <svg
                                ...
                                <div className="mt-4 flex space-x-3 auto">
                                    <ul>
                                        <li className="font-light text-md">Monday:</li>
                                        <li className="font-light text-md">Tuesday:</li>
                                        <li className="font-light text-md">Wednesday:</li>
                                        <li className="font-light text-md">Thursday:</li>
                                        <li className="font-light text-md">Friday:</li>
                                        <li className="font-light text-md">Saturday:</li>
                                        <li className="font-light text-md">Sunday:</li>
                                    </ul>
                                    <ul>
