                ...
                <div className="mb-9 text-center text-2xl tracking-tight font-bold text-cyan-900">
                    ...
                    <div className="flex flex-wrap max-w-xl mx-auto mt-12">
                        <div className="w-6/12 text-center block">
                            ...
                            <button className="inline-block bg-orange-600 text-white border-none outline-none py-0 px-5 h-9 leading-9 text-xs rounded no-underline duration-200 ease-in-out transition-colors font-medium cursor-pointer normal-case m-0"
                                onClick={toSearchPage}>Choose</button>
                        </div>
