                    ...
                    >
                      <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div className="py-4 text-center">
                          <div>
                            <p className="text-text-dark block px-4 text-xs">
                              Signed in as
                            </p>
                            <h3 className="text-text-dark block px-4 text-lg font-semibold">
                              {authState.name}
                            </h3>
                          </div>
                        </div>
      ...
      <header className="z-30 bg-gradient-to-b from-primary-100 to-primary-200 pb-6 md:pb-0">
        <div className="mx-auto px-5 sm:px-6">
          <div className="flex items-center justify-between h-16 md:h-20 relative">
            ...
            <div className="shrink-0 mr-4 py-2">
              {/* Logo */}
              <Link to="/login/menu" className="flex items-center">
                <img className="mx-auto h-8" src={LogoImg} alt="Logo" />
              </Link>
            </div>
