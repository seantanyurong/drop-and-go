...
const UserBookingProvider = (props) => {
  let navigate = useNavigate();
  const [userOfBooking, setUserOfBooking] = useState(null);
        ...
        >
          <div className="flex items-center mb-1 justify-between">
            <div className="flex space-x-3 items-center">
              <h3 className="font-semibold">{userOfBooking?.name}</h3>
